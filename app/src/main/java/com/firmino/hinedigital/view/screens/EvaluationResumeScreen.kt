...
fun EvaluationResumeScreen(navController: NavController, viewModel: EvaluationViewModel, id: Long?) {
    ...
    Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
        ...
        Column(
            ...
            Header(title = "Resumo Avaliativo", onBackPressed = { navController.popBackStack() })
            if (evaluation != null) {
                ...
                Content(evaluation) {
                    navController.navigate("exam/$id/$it")
                }
            }
        }
    }
...
@Composable
private fun Content(evaluation: Evaluation, onEvaluationItemClicked: (index: Int) -> Unit) {
